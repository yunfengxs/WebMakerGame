...
import {DataManager} from "./ts/Test/DataManager";
...
function InitSettings(){
    ...
    CreateElementWithClasses("div","test",settings_home,["setting_button","load_bt"]).addEventListener("click",() => {
        dataManager.openDatasPage()
    })
